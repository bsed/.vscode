...
<html lang="en">
<head>
    <title>Code coverage report for src/nodes/define.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/nodes/</a> define.js
    </h1>
    <div class='clearfix'>
 ...
 */
Define.prototype.getName = <span class="fstat-no" title="function not covered" >function() {</span>
 ...
 */
Define.prototype.getValue = <span class="fstat-no" title="function not covered" >function() {</span>
...
Define.prototype.consume = function(file, parent, ast) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (ast.arguments.length &gt; 1) {
        this.value = Expr.resolve(this, ast.arguments[1]);
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (ast.arguments.length &gt; 2) {
<span class="cstat-no" title="statement not covered" >        this.caseInsensitive = expr.resolve(this, ast.arguments[2]);</span>
    } else {
