...
var FirefoxDebugSession = (function (_super) {
    ...
    FirefoxDebugSession.prototype.launchRequest = function (response, args) {
        var _this = this;
        var configError = this.readWebRootConfiguration(args);
        if (configError) {
    ...
    FirefoxDebugSession.prototype.readWebRootConfiguration = function (args) {
        if (args.url) {
            if (!args.webRoot) {
    ...
    FirefoxDebugSession.prototype.attachThread = function (threadActor, threadAdapter) {
        ...
        threadActor.onResumed(function () {
            ...
            _this.sendEvent(new ContinuedEvent(threadAdapter.id));
        });
...
var ContinuedEvent = (function () {
    function ContinuedEvent(threadId) {
        this.seq = 0;
        this.type = 'event';
