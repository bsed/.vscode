...
var ThreadAdapter = (function () {
    ...
    ThreadAdapter.prototype.createSourceAdapter = function (id, actor) {
        var adapter = new index_1.SourceAdapter(id, actor);
    ...
    ThreadAdapter.prototype.findSourceAdapterForUrl = function (url) {
