...
function activate(ctx) {
    if (ctx.globalState.get('chrisdias.vscodeEditorConfig.informUser', true)) {
        vscode_1.window.showInformationMessage("This version of EditorConfig has been deprecated, more information is available online.", "How to Upgrade").then(function (selection) {
            if (selection) {
