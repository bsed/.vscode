    ...
    static show(log, uri, maxCount, defaultMaxCount, goBackCommand) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (maxCount !== 0 && items.length >= defaultMaxCount) {
                ...
                }, commands_1.Commands.ShowQuickFileHistory, [uri, 0, undefined, goBackCommand]));
            }
            if (!goBackCommand) {
                items.splice(0, 0, new quickPicks_1.CommandQuickPickItem({
                ...
                }, commands_1.Commands.ShowQuickRepoHistory, [undefined, undefined, undefined, new quickPicks_1.CommandQuickPickItem({
                        label: `go back \u21A9`,
                        description: null
