...
class BlameActiveLineController extends vscode_1.Disposable {
    constructor(context, git, blameabilityTracker, annotationController) {
        super(() => this.dispose());
        this.git = git;
        this.blameabilityTracker = blameabilityTracker;
    ...
    _onActiveTextEditorChanged(editor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._editor = editor;
            this._uri = yield gitProvider_1.GitUri.fromUri(editor.document.uri, this.git);
