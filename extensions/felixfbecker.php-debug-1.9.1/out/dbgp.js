...
exports.DbgpConnection = exports.ENCODING = undefined;
...
const ENCODING = exports.ENCODING = 'iso-8859-1';
...
class DbgpConnection extends _events.EventEmitter {
    constructor(socket) {
        super();
        this._socket = socket;
        ...
        if (this._parsingState === ParsingState.DataLength) {
            ...
            if (this._chunksDataLength + data.length >= this._dataLength) {
                ...
                const parser = new _xmldom.DOMParser({
                    errorHandler: {
                        warning: _warning => {
                            this.emit('warning', _warning);
                        },
                        error: _error => {
                            this.emit('error', _error instanceof Error ? _error : new Error(_error));
                        },
                        fatalError: error => {
