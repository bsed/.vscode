            ...
            const createServer = () => new Promise((resolve, reject) => {
                ...
                server.on('connection', socket => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        // raise default of 32
                        yield connection.sendFeatureSetCommand('max_children', '9999');
                        // don't truncate long variable values
                        yield connection.sendFeatureSetCommand('max_data', '0');
            ...
            try {
                ...
                if (connections.length === 0) {
                    ...
                    yield Promise.all(connections.map((connection, connectionIndex) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield Promise.all(breakpoints.filter(breakpoint => breakpoint instanceof xdebug.LineBreakpoint && breakpoint.fileUri === fileUri).map(breakpoint => breakpoint.remove()));
                        // set new breakpoints
