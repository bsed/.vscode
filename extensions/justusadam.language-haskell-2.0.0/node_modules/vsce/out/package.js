...
var ReadmeProcessor = (function (_super) {
    ...
    function ReadmeProcessor(manifest, options) {
        if (options === void 0) { options = {}; }
        _super.call(this, manifest, /^extension\/readme.md$/i, 'Microsoft.VisualStudio.Services.Content.Details', options);
    }
...
var ChangelogProcessor = (function (_super) {
    ...
    function ChangelogProcessor(manifest, options) {
        if (options === void 0) { options = {}; }
        _super.call(this, manifest, /^extension\/changelog.md$/i, 'Microsoft.VisualStudio.Services.Content.Changelog', options);
    }
...
var LicenseProcessor = (function (_super) {
    ...
    function LicenseProcessor(manifest) {
        ...
        if (!match || !match[1]) {
            this.filter = function (name) { return /^extension\/license(\.(md|txt))?$/i.test(name); };
        }
        else {
...
function toContentTypes(files) {
    var extensions = Object.keys(_.keyBy(files, function (f) { return path.extname(f.path).toLowerCase(); }))
        ...
        .reduce(function (r, e) { return _.assign(r, (_a = {}, _a[e] = mime.lookup(e), _a)); var _a; }, {});
