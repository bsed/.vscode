...
exports.Connection = exports.FeatureSetResponse = exports.EvalResponse = exports.EvalResultProperty = exports.PropertyGetResponse = exports.ContextGetResponse = exports.Property = exports.BaseProperty = exports.ContextNamesResponse = exports.Context = exports.SourceResponse = exports.StackGetResponse = exports.StackFrame = exports.BreakpointListResponse = exports.BreakpointSetResponse = exports.ConditionalBreakpoint = exports.ExceptionBreakpoint = exports.CallBreakpoint = exports.LineBreakpoint = exports.Breakpoint = exports.StatusResponse = exports.Response = exports.XDebugError = exports.InitPacket = undefined;

var _iconvLite = require('iconv-lite');

var iconv = _interopRequireWildcard(_iconvLite);

var _dbgp = require('./dbgp');
...
exports.InitPacket = InitPacket; /** Error class for errors returned from XDebug */
...
exports.XDebugError = XDebugError; /** The base class for all XDebug responses to commands executed on a connection */
...
exports.Response = Response; /** A response to the status command */
...
exports.StatusResponse = StatusResponse; /** Abstract base class for all breakpoints */
...
exports.Breakpoint = Breakpoint; /** class for line breakpoints. Returned from a breakpoint_list or passed to sendBreakpointSetCommand */
...
exports.LineBreakpoint = LineBreakpoint; /** class for call breakpoints. Returned from a breakpoint_list or passed to sendBreakpointSetCommand */
...
exports.CallBreakpoint = CallBreakpoint; /** class for exception breakpoints. Returned from a breakpoint_list or passed to sendBreakpointSetCommand */
...
exports.ExceptionBreakpoint = ExceptionBreakpoint; /** class for conditional breakpoints. Returned from a breakpoint_list or passed to sendBreakpointSetCommand */
...
exports.ConditionalBreakpoint = ConditionalBreakpoint; /** Response to a breakpoint_set command */
...
exports.BreakpointSetResponse = BreakpointSetResponse; /** The response to a breakpoint_list command */
...
exports.BreakpointListResponse = BreakpointListResponse; /** One stackframe inside a stacktrace retrieved through stack_get */
...
exports.StackFrame = StackFrame; /** The response to a stack_get command */
...
exports.SourceResponse = SourceResponse; /** A context inside a stack frame, like "Local" or "Superglobals" */
...
exports.Context = Context; /** Response to a context_names command */
...
exports.ContextNamesResponse = ContextNamesResponse; /** The parent for properties inside a scope and properties retrieved through eval requests */
...
exports.BaseProperty = BaseProperty; /** a property (variable) inside a context or a child of another property */
...
exports.Property = Property; /** The response to a context_get command */
...
exports.ContextGetResponse = ContextGetResponse; /** The response to a property_get command */
...
exports.PropertyGetResponse = PropertyGetResponse; /** class for properties returned from eval commands. These don't have a full name or an ID, but have all children already inlined. */
...
exports.EvalResultProperty = EvalResultProperty; /** The response to an eval command */
...
exports.EvalResponse = EvalResponse; /** The response to an feature_set command */
...
class Connection extends _dbgp.DbgpConnection {
    ...
    _enqueueCommand(name, args, data) {
        return new Promise((resolveFn, rejectFn) => {
            const command = { name: name, args: args, data: data, resolveFn: resolveFn, rejectFn: rejectFn };
    ...
    sendPropertyGetCommand(property) {
        return __awaiter(this, void 0, Promise, function* () {
            ...
            return new PropertyGetResponse((yield this._enqueueCommand('property_get', `-d ${ property.context.stackFrame.level } -c ${ property.context.id } -n ${ property.fullName }`)), property);
        });
    }
    // ------------------------------- eval -----------------------------------------
    ...
    sendEvalCommand(expression) {
        return __awaiter(this, void 0, Promise, function* () {
            return new EvalResponse((yield this._enqueueCommand('eval', null, expression)), this);
        });
    }
}
exports.Connection = Connection; /** a counter for unique connection IDs */
