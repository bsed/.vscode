...
class PhpDebugSession extends vscode.DebugSession {
            ...
            const createServer = () => new Promise((resolve, reject) => {
                ...
                server.on('connection', socket => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        yield connection.sendFeatureSetCommand('max_data', semver.lt(initPacket.engineVersion, '2.2.4') ? '10000' : '0');
    ...
    convertDebuggerPathToClient(fileUri) {
    ...
    isSameUri(clientUri, debuggerUri) {
    ...
    convertClientPathToDebugger(localPath) {
        ...
        let serverFileUri;
        if (this._args.serverSourceRoot && this._args.localSourceRoot) {
            let localSourceRootUrl = (0, _fileUrl2.default)(this._args.localSourceRoot, { resolve: false });
            if (!localSourceRootUrl.endsWith('/')) {
                localSourceRootUrl += '/';
            }
            let serverSourceRootUrl = (0, _fileUrl2.default)(this._args.serverSourceRoot, { resolve: false });
            ...
            try {
                ...
                if (connections.length === 0) {
                    ...
                    yield Promise.all(connections.map((connection, connectionIndex) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield Promise.all(breakpoints.filter(breakpoint => breakpoint instanceof xdebug.LineBreakpoint && this.isSameUri(fileUri, breakpoint.fileUri)).map(breakpoint => breakpoint.remove()));
                        // set new breakpoints
                        yield Promise.all(xdebugBreakpoints.map((breakpoint, index) => __awaiter(this, void 0, void 0, function* () {
                            try {
                                const response = yield connection.sendBreakpointSetCommand(breakpoint);
