...
var IntellisenseHelper = (function () {
    ...
    IntellisenseHelper.setupReactNativeIntellisense = function () {
        ...
        var configureWorkspace = Q({})
            .then(function () { return tsconfigHelper_1.TsConfigHelper.allowJs(true); })
            .then(function () { return tsconfigHelper_1.TsConfigHelper.addExcludePaths(["node_modules"]); })
    ...
    IntellisenseHelper.installReactNativeTypings = function () {
        var reactTypingsSource = path.resolve(__dirname, "..", "..", "ReactTypings");
        var reactTypingsDest = path.resolve(vscode.workspace.rootPath, ".vscode", "typings");
