...
var commandPaletteHandler = new commandPaletteHandler_1.CommandPaletteHandler(projectRootPath, globalPackager, packagerStatusIndicator);
            ...
            if (isRNProject) {
                ...
                entryPointHandler.runFunction("debugger.setupLauncherStub", errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.DebuggerStubLauncherFailed), function () {
                    return setupReactNativeDebugger()
                        ...
                        .then(function () {
                        return setupAndDispose(new extensionServer_1.ExtensionServer(projectRootPath, globalPackager, packagerStatusIndicator), context);
                    })
                        .then(function () { });
                });
