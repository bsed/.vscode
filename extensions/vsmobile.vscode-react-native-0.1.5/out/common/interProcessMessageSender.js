...
var InterProcessMessageSender = (function () {
    ...
    InterProcessMessageSender.prototype.sendMessage = function (message, args) {
        ...
        var failPromise = function () {
            return deferred.reject(errorHelper_1.ErrorHelper.getInternalError(internalErrorCode_1.InternalErrorCode.ErrorWhileProcessingMessageInIPMSServer, extensionMessaging_1.ExtensionMessage[message]));
        };
