...
var PlistBuddy = (function () {
    ...
    PlistBuddy.prototype.getBundleId = function (projectRoot, simulator) {
        ...
        return this.xcodeproj.findXcodeprojFile(projectRoot).then(function (projectFile) {
            var appName = path.basename(projectFile, path.extname(projectFile));
            var infoPlistPath = path.join(projectRoot, "build", "Build", "Products", simulator ? "Debug-iphonesimulator" : "Debug-iphoneos", appName + ".app", "Info.plist");
