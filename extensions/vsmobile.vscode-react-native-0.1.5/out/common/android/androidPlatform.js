...
var AndroidPlatform = (function () {
    function AndroidPlatform(runOptions, _a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.remoteExtension, remoteExtension = _c === void 0 ? remoteExtension_1.RemoteExtension.atProjectRootPath(runOptions.projectRoot) : _c, _d = _b.adb, adb = _d === void 0 ? new adb_1.Adb() : _d, _e = _b.reactNative, reactNative = _e === void 0 ? new reactNative_1.ReactNative() : _e, _f = _b.fileSystem, fileSystem = _f === void 0 ? new fileSystem_1.FileSystem() : _f;
    ...
    AndroidPlatform.prototype.runApp = function (shouldLaunchInAllDevices) {
        ...
        return telemetryHelper_1.TelemetryHelper.generate("AndroidPlatform.runApp", function () {
            var runAndroidSpawn = _this.reactNative.runAndroid(_this.runOptions.projectRoot);
