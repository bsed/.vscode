...
var FileSystem = (function () {
    ...
    FileSystem.prototype.findFilesByExtension = function (folder, extension) {
        return Q.nfcall(this.fs.readdir, folder).then(function (files) {
            var extFiles = files.filter(function (file) { return path.extname(file) === "." + extension; });
