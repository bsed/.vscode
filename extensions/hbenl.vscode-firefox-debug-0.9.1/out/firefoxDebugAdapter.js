...
class FirefoxDebugAdapter extends debugAdapterBase_1.DebugAdapterBase {
    ...
    launch(args) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (args.reAttach) {
                ...
                try {
                    socket = yield launcher_1.connect(args.port || 6000, 'localhost');
            ...
            if (socket === undefined) {
                let sendToConsole = (this.addonType === 'addonSdk') ?
                    (msg) => this.sendEvent(new vscode_debugadapter_1.OutputEvent(msg, 'stdout')) :
                    (msg) => undefined;
                let proc = yield launcher_1.launchFirefox(args, sendToConsole);
                if (!args.reAttach) {
                    this.firefoxProc = proc;
                }
                socket = yield launcher_1.waitForSocket(args);
            }
            ...
            rootActor.onInit(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                addons.forEach((addon) => {
                    if (addon.id === this.addonId) {
                        let tabActor = new index_1.TabActorProxy(addon.actor, addon.name, '', this.firefoxDebugConnection);
                        let consoleActor = new index_1.ConsoleActorProxy(addon.consoleActor, this.firefoxDebugConnection);
    ...
    attachTab(tabActor, consoleActor, tabId, hasWorkers, threadName) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let threadAdapter = new index_2.ThreadAdapter(threadId, threadActor, consoleActor, this.threadPauseCoordinator, threadName, this);
            ...
            try {
                yield threadAdapter.init(this.exceptionBreakpoints, reload);
    ...
    attachWorker(workerActor, tabId, workerId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let threadId = this.nextThreadId++;
            let threadAdapter = new index_2.ThreadAdapter(threadId, threadActor, undefined, this.threadPauseCoordinator, `Worker ${tabId}/${workerId}`, this);
            this.attachThread(threadAdapter, threadActor.name);
            yield threadAdapter.init(this.exceptionBreakpoints, false);
            this.threadsById.set(threadId, threadAdapter);
            this.sendEvent(new vscode_debugadapter_1.ThreadEvent('started', threadId));
            workerActor.onClose(() => {
                this.threadsById.delete(threadId);
