...
var Documenter = (function () {
    ...
    Documenter.prototype._insertDocumentation = function (sb, position, editor, edit, sourceFile, withStart) {
        ...
        if (!withStart) {
            ...
            var commentText = sb.toCommentString(indent, withStart);
    ...
    Documenter.prototype._emitPropertyDeclaration = function (sb, node) {
        ...
        if (node.type && node.type.getText().indexOf("=>") === -1) {
            var type = utils.formatTypeName(node.type.getText());
