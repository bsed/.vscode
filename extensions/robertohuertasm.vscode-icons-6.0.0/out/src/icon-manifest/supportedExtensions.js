...
exports.extensions = {
    ...
    supported: [
        ...
        { icon: 'appveyor', extensions: ['appveyor.yml', '.appveyor.yml'], filename: true, format: models_1.FileFormat.png },
        { icon: 'ansible', extensions: ['ansible'], format: models_1.FileFormat.svg },
        { icon: 'asp', extensions: ['asp'], format: models_1.FileFormat.png },
        { icon: 'aspx', extensions: ['aspx', 'ascx'], format: models_1.FileFormat.png },
        { icon: 'assembly', extensions: ['s', 'asm'], format: models_1.FileFormat.png },
        { icon: 'autohotkey', extensions: ['ahk'], format: models_1.FileFormat.png },
        ...
        { icon: 'bat', extensions: [], languages: [languages_1.languages.bat], format: models_1.FileFormat.png },
        { icon: 'binary', extensions: ['bin', 'o', 'a', 'exe', 'obj', 'lib', 'dll', 'so', 'pyc', 'pyd', 'pyo', 'n', 'ndll', 'pdb', 'cmo', 'cmx', 'cma', 'cmxa', 'cmi'], format: models_1.FileFormat.png },
        ...
        { icon: 'cake', extensions: ['cake'], format: models_1.FileFormat.png },
        { icon: 'cakephp', extensions: [], format: models_1.FileFormat.svg },
        { icon: 'cfm', extensions: ['cfm', 'cfc', 'lucee'], format: models_1.FileFormat.png },
        { icon: 'cheader', extensions: ['h'], format: models_1.FileFormat.png },
        { icon: 'class', extensions: ['class'], format: models_1.FileFormat.svg },
        { icon: 'clojure', extensions: ['cjm', 'cljc'], languages: [languages_1.languages.clojure], format: models_1.FileFormat.png },
        { icon: 'cmake', extensions: ['CMakeCache.txt', 'CMakeLists.txt', '.cmake'], filename: true, format: models_1.FileFormat.svg },
        { icon: 'cobol', extensions: ['cbl', 'cob', 'cpy'], format: models_1.FileFormat.png },
        { icon: 'codeclimate', extensions: ['codeclimate.yml'], filename: true, format: models_1.FileFormat.png },
        { icon: 'coffeescript', extensions: [], languages: [languages_1.languages.coffeescript], format: models_1.FileFormat.svg },
        { icon: 'config', extensions: ['env', 'config'], languages: [languages_1.languages.properties], format: models_1.FileFormat.png },
        { icon: 'config', extensions: ['.env.example'], filename: true, format: models_1.FileFormat.png },
        ...
        { icon: 'csharp', extensions: ['csx'], languages: [languages_1.languages.csharp], format: models_1.FileFormat.png },
        { icon: 'cshtml', extensions: [], languages: [languages_1.languages.razor], format: models_1.FileFormat.png },
        ...
        { icon: 'csslint', extensions: ['.csslintrc'], filename: true, format: models_1.FileFormat.png },
        { icon: 'cssmap', extensions: ['css.map'], format: models_1.FileFormat.png },
        { icon: 'cucumber', extensions: ['feature'], format: models_1.FileFormat.png },
        { icon: 'dartlang', extensions: ['dart'], format: models_1.FileFormat.png },
        { icon: 'delphi', extensions: ['pas', 'dfm', 'dpr'], format: models_1.FileFormat.png },
        { icon: 'dlang', extensions: ['d'], format: models_1.FileFormat.png },
        ...
        { icon: 'editorconfig', extensions: ['.editorconfig'], filename: true, format: models_1.FileFormat.png },
        ...
        { icon: 'elm', extensions: ['elm'], format: models_1.FileFormat.png },
        { icon: 'elm', extensions: ['elm-package.json'], filename: true, format: models_1.FileFormat.png },
        ...
        { icon: 'excel', extensions: ['xls', 'xlsx', 'csv', 'ods'], format: models_1.FileFormat.svg },
        ...
        { icon: 'fsharp', extensions: [], languages: [languages_1.languages.fsharp], format: models_1.FileFormat.png },
        { icon: 'font', extensions: ['woff', 'woff2', 'ttf', 'otf', 'eot', 'pfa', 'pfb', 'sfd'], format: models_1.FileFormat.png },
        { icon: 'fortran', extensions: ['f90', 'mod', 'f'], format: models_1.FileFormat.png },
        ...
        { icon: 'groovy', extensions: [], languages: [languages_1.languages.groovy], format: models_1.FileFormat.png },
        { icon: 'gruntfile', extensions: ['gruntfile.js'], filename: true, format: models_1.FileFormat.png },
        ...
        { icon: 'haxecheckstyle', extensions: ['checkstyle.json'], filename: true, format: models_1.FileFormat.png },
        { icon: 'haxedevelop', extensions: ['hxproj'], format: models_1.FileFormat.png },
        ...
        { icon: 'ini', extensions: [], languages: [languages_1.languages.ini], format: models_1.FileFormat.png },
        { icon: 'ionic', extensions: ['ionic.project'], filename: true, format: models_1.FileFormat.png },
        { icon: 'ionic', extensions: ['ionic.config.json'], filename: true, format: models_1.FileFormat.png },
        { icon: 'jade', extensions: [], languages: [languages_1.languages.pug], format: models_1.FileFormat.png },
        { icon: 'jade', extensions: ['.jade-lintrc', '.pug-lintrc', '.jade-lint.json', '.pug-lintrc.js', '.pug-lintrc.json'], filename: true, format: models_1.FileFormat.png },
        ...
        { icon: 'jshintrc', extensions: ['.jshintrc'], filename: true, format: models_1.FileFormat.png },
        { icon: 'jsmap', extensions: ['js.map'], format: models_1.FileFormat.png },
        { icon: 'json', extensions: [], languages: [languages_1.languages.json], format: models_1.FileFormat.png },
        { icon: 'jsp', extensions: ['jsp'], format: models_1.FileFormat.png },
        { icon: 'julia', extensions: ['jl'], format: models_1.FileFormat.png },
        ...
        { icon: 'lerna', extensions: ['lerna.json'], filename: true, format: models_1.FileFormat.png },
        { icon: 'less', extensions: [], languages: [languages_1.languages.less], format: models_1.FileFormat.svg },
        { icon: 'license', extensions: ['enc'], format: models_1.FileFormat.png },
        { icon: 'license', extensions: ['license', 'licence', 'license.md', 'licence.md'], filename: true, format: models_1.FileFormat.png },
        { icon: 'lisp', extensions: ['bil'], format: models_1.FileFormat.png },
        { icon: 'lime', extensions: ['hxp'], format: models_1.FileFormat.png },
        { icon: 'lime', extensions: ['include.xml'], filename: true, format: models_1.FileFormat.png },
        { icon: 'locale', extensions: [], format: models_1.FileFormat.svg },
        { icon: 'log', extensions: ['log'], format: models_1.FileFormat.png },
        { icon: 'lsl', extensions: ['lsl'], format: models_1.FileFormat.png },
        { icon: 'lua', extensions: [], languages: [languages_1.languages.lua], format: models_1.FileFormat.png },
        { icon: 'm', extensions: [], languages: [languages_1.languages.objectivec], format: models_1.FileFormat.png },
        { icon: 'makefile', extensions: ['makefile'], format: models_1.FileFormat.png },
        { icon: 'makefile', extensions: [], languages: [languages_1.languages.makefile], format: models_1.FileFormat.png },
        { icon: 'markdown', extensions: ['mdown', 'markdown'], languages: [languages_1.languages.markdown], format: models_1.FileFormat.svg },
        { icon: 'marko', extensions: ['marko'], format: models_1.FileFormat.png },
        { icon: 'markojs', extensions: ['marko.js'], format: models_1.FileFormat.png },
        { icon: 'markup', extensions: [], format: models_1.FileFormat.png },
        { icon: 'matlab', extensions: ['fig', 'mat', 'mex', 'mexn', 'mexrs6', 'mn', 'mum', 'mx', 'mx3', 'rwd', 'slx', 'slddc', 'smv', 'tikz', 'xvc', 'xvc'], format: models_1.FileFormat.png },
        { icon: 'masterpage', extensions: ['master'], format: models_1.FileFormat.png },
        { icon: 'meteor', extensions: [], format: models_1.FileFormat.svg },
        { icon: 'mustache', extensions: ['mustache', 'mst'], format: models_1.FileFormat.png },
        { icon: 'nim', extensions: ['nim', 'nims'], format: models_1.FileFormat.png },
        { icon: 'node', extensions: ['.nvmrc'], filename: true, format: models_1.FileFormat.svg },
        { icon: 'node2', extensions: [], format: models_1.FileFormat.svg },
        ...
        { icon: 'nunjucks', extensions: ['njk', 'nunjucks', 'nunjs', 'nunj', 'njs', 'nj'], format: models_1.FileFormat.png },
        { icon: 'ocaml', extensions: ['ml', 'mll', 'mli', 'mly', 'ocamlmakefile', 'merlin'], format: models_1.FileFormat.png },
        { icon: 'paket', extensions: ['paket.dependencies', 'paket.lock', 'paket.references', 'paket.template', 'paket.local'], filename: true, format: models_1.FileFormat.png },
        { icon: 'patch', extensions: ['patch'], format: models_1.FileFormat.png },
        { icon: 'pdf', extensions: ['pdf'], format: models_1.FileFormat.svg },
        { icon: 'perl', extensions: [], languages: [languages_1.languages.perl], format: models_1.FileFormat.png },
        { icon: 'photoshop', extensions: ['psd'], format: models_1.FileFormat.png },
        ...
        { icon: 'powershell', extensions: [], languages: [languages_1.languages.powershell], format: models_1.FileFormat.png },
        { icon: 'procfile', extensions: ['procfile'], filename: true, format: models_1.FileFormat.png },
        { icon: 'prolog', extensions: ['pro', 'P'], languages: [languages_1.languages.prolog], format: models_1.FileFormat.png },
        { icon: 'protobuf', extensions: ['proto'], format: models_1.FileFormat.png },
        { icon: 'protractor', extensions: ['protractor.conf.js'], filename: true, format: models_1.FileFormat.png },
        { icon: 'puppet', extensions: ['epp', 'pp'], format: models_1.FileFormat.png },
        ...
        { icon: 'qlikview', extensions: ['qvd', 'qvw'], format: models_1.FileFormat.png },
        { icon: 'r', extensions: [], languages: [languages_1.languages.r], format: models_1.FileFormat.png },
        ...
        { icon: 'reacttemplate', extensions: ['rt'], format: models_1.FileFormat.png },
        { icon: 'reactts', extensions: ['tsx'], format: models_1.FileFormat.png },
        ...
        { icon: 'robotframework', extensions: ['robot'], format: models_1.FileFormat.png },
        ...
        { icon: 'scala', extensions: ['scala'], format: models_1.FileFormat.png },
        ...
        { icon: 'settings', extensions: [], format: models_1.FileFormat.png },
        { icon: 'shell', extensions: ['fish'], languages: [languages_1.languages.shellscript], format: models_1.FileFormat.png },
        { icon: 'slim', extensions: [], format: models_1.FileFormat.png },
        { icon: 'sln', extensions: ['sln'], format: models_1.FileFormat.png },
        { icon: 'smarty', extensions: ['tpl', 'swig'], format: models_1.FileFormat.png },
        ...
        { icon: 'sql', extensions: [], languages: [languages_1.languages.sql], format: models_1.FileFormat.png },
        { icon: 'sqlite', extensions: ['sqlite', 'sqlite3', 'db3'], format: models_1.FileFormat.png },
        { icon: 'sss', extensions: ['sss'], format: models_1.FileFormat.svg },
        { icon: 'style', extensions: [], format: models_1.FileFormat.svg },
        { icon: 'stylelint', extensions: ['.stylelintrc', 'stylelint.config.js'], filename: true, format: models_1.FileFormat.png },
        ...
        { icon: 'tex', extensions: ['texi', 'tex'], format: models_1.FileFormat.png },
        { icon: 'text', extensions: [], languages: [languages_1.languages.plaintext], format: models_1.FileFormat.png },
        { icon: 'textile', extensions: ['textile'], format: models_1.FileFormat.png },
        { icon: 'todo', extensions: ['todo'], format: models_1.FileFormat.png },
        { icon: 'toml', extensions: ['toml'], format: models_1.FileFormat.svg },
        { icon: 'travis', extensions: ['.travis.yml'], filename: true, format: models_1.FileFormat.png },
        { icon: 'tslint', extensions: ['tslint.json'], filename: true, format: models_1.FileFormat.png },
        ...
        { icon: 'vagrant', extensions: ['vagrantfile'], filename: true, format: models_1.FileFormat.png },
        { icon: 'vash', extensions: ['vash'], format: models_1.FileFormat.png },
        { icon: 'vb', extensions: [], languages: [languages_1.languages.vb], format: models_1.FileFormat.png },
        { icon: 'vbhtml', extensions: ['vbhtml'], format: models_1.FileFormat.png },
        ...
        { icon: 'volt', extensions: ['volt'], format: models_1.FileFormat.png },
        {
            icon: 'vscode',
            extensions: [
                'vscodeignore.json',
        ...
        { icon: 'vue', extensions: ['vue'], format: models_1.FileFormat.png },
        {
            icon: 'webpack',
            extensions: [
                'webpack.config.js',
        ...
        { icon: 'wxml', extensions: ['wxml'], format: models_1.FileFormat.png },
        { icon: 'wxss', extensions: ['wxss'], format: models_1.FileFormat.png },
        { icon: 'xib', extensions: ['xib'], format: models_1.FileFormat.png },
        { icon: 'xliff', extensions: ['xliff', 'xlf'], format: models_1.FileFormat.png },
        { icon: 'xml', extensions: ['pex'], languages: [languages_1.languages.xml], format: models_1.FileFormat.png },
        { icon: 'xsl', extensions: [], languages: [languages_1.languages.xsl], format: models_1.FileFormat.png },
        ...
        { icon: 'zip', extensions: ['zip', 'rar', '7z', 'tar', 'gz', 'bzip2', 'xz', 'bz2'], format: models_1.FileFormat.png },
    ],
};
