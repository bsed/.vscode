...
exports.extensions = {
    ...
    supported: [
        ...
        { icon: 'dist', extensions: ['dist', 'out', 'export', 'build'], format: models_1.FileFormat.svg },
        ...
        { icon: 'images', extensions: ['images', 'img'], format: models_1.FileFormat.svg },
        { icon: 'less', extensions: ['less'], format: models_1.FileFormat.svg },
        { icon: 'locale', extensions: ['locale', 'locales'], format: models_1.FileFormat.svg },
