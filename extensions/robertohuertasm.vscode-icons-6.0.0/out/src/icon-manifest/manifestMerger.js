...
function toggleTypescriptOfficialPreset(disable, customFiles) {
...
exports.toggleTypescriptOfficialPreset = toggleTypescriptOfficialPreset;
function toggleJavascriptOfficialPreset(disable, customFiles) {
    const temp = togglePreset(disable, ['js_official'], customFiles);
    return togglePreset(!disable, ['js'], temp);
}
exports.toggleJavascriptOfficialPreset = toggleJavascriptOfficialPreset;
