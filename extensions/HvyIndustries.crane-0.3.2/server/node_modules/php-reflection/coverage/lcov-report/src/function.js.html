...
<html lang="en">
<head>
    <title>Code coverage report for src/function.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> function.js
    </h1>
    <div class='clearfix'>
...
fn.prototype.consume = function(ast) {
  ...
  this.uses = [];
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isClosure) {
<span class="cstat-no" title="statement not covered" >    this.fullName = this.name = '#closure';</span>
<span class="cstat-no" title="statement not covered" >    for(var i = 0; i &lt; ast.uses.length; i++) {</span>
      // @fixme : should refer to an existing variable (if any)
<span class="cstat-no" title="statement not covered" >      this.uses.push(</span>
  ...
  // parse inner body
  <span class="missing-if-branch" title="else path not taken" >E</span>if (ast.body &amp;&amp; ast.body.children) {
