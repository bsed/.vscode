...
<html lang="en">
<head>
    <title>Code coverage report for src/reference.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> reference.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">19516×</span>
<span class="cline-any cline-yes">19516×</span>
<span class="cline-any cline-yes">19516×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">16396×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
var reference = function(from, to, type) {
  this.from = from;
  this.type = type;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (to instanceof node) {
<span class="cstat-no" title="statement not covered" >    this.to = to;</span>
<span class="cstat-no" title="statement not covered" >    this.nodeType = to.type;</span>
<span class="cstat-no" title="statement not covered" >    if (to.fullName) {</span>
<span class="cstat-no" title="statement not covered" >      this.name = to.fullName;</span>
    } else <span class="cstat-no" title="statement not covered" >if (to.name) {</span>
<span class="cstat-no" title="statement not covered" >      this.name = to.name;</span>
    }
    // link to related node
<span class="cstat-no" title="statement not covered" >    this.to.relations.push(this);</span>
  }
};
&nbsp;
/**
 ...
 * @return {reference}
 */
reference.toTrait = <span class="fstat-no" title="function not covered" >function(from, traitName, type) {</span>
<span class="cstat-no" title="statement not covered" >  return this.toNode(from, traitName, 'trait', type);</span>
};
&nbsp;
/**
...
reference.toNode = function(from, nodeName, nodeType, referenceType) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof nodeName !== 'string') {
 ...
 * @return {node|null}
 */
reference.prototype.get = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  if (!this.to) <span class="cstat-no" title="statement not covered" >this.resolve();</span></span>
<span class="cstat-no" title="statement not covered" >  return this.to;</span>
};
&nbsp;
/**
 * Resolves the reference
 */
reference.prototype.resolve = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  if (!this.to) {</span>
<span class="cstat-no" title="statement not covered" >    if (!this.from || !this.nodeType || !this.name) {</span>
<span class="cstat-no" title="statement not covered" >      return false;</span>
    }
<span class="cstat-no" title="statement not covered" >    var repository = this.from.getFile().repository;</span>
<span class="cstat-no" title="statement not covered" >    this.to = repository.getFirstByName(this.nodeType, this.name);</span>
<span class="cstat-no" title="statement not covered" >    if (this.to) {</span>
