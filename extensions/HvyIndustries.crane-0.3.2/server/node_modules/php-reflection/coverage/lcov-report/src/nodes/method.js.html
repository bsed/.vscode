...
<html lang="en">
<head>
    <title>Code coverage report for src/nodes/method.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/nodes/</a> method.js
    </h1>
    <div class='clearfix'>
 ...
 */
Method.prototype.getClass = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    return this.getParent();</span>
};
&nbsp;
/**
 * Gets the definition object
 * @return {Class|Interface|Trait}
 */
Method.prototype.getArguments = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    return this._db.resolve(</span>
        this.get('args')
    );
};
&nbsp;
 ...
 * @return {Class|Interface|Trait}
 */
Method.prototype.getVariables = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    var items = this.getArguments();</span>
    // @todo
...
<span class="cstat-no" title="statement not covered" >        this.add(</span>
            'args',
