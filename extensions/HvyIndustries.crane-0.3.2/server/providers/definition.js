...
class DefinitionProvider {
    ...
    findDefinition() {
        ...
        let nodes = this.findTopLevelSymbols(classInfo);
    ...
    findTopLevelSymbols(classInfo) {
        ...
        this.workspaceTree.forEach(filenode => {
            ...
            filenode.traits.forEach((traitNode) => {
                if (traitNode.name.toLowerCase() == rawClassname.toLowerCase()
            ...
            filenode.interfaces.forEach((interfaceNode) => {
                if (interfaceNode.name.toLowerCase() == rawClassname.toLowerCase()
