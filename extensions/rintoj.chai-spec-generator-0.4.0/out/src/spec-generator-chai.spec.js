...
describe('generateSpec in chai style', function () {
    ...
    it('should generate spec for throw in es6 style', function () {
        var result = spec_generator_1.generateSpec('throw calc(1, true)', { special: true });
        chai_1.expect(result).be.a('array');
        chai_1.expect(result).be.length(1);
        chai_1.expect(result[0]).be.equal('expect(() => calc(1, true)).to.throw();');
    });
    it('should generate spec for throw in es5 style', function () {
        var result = spec_generator_1.generateSpec('throw calc(1, true)', { special: true, es6: false });
        chai_1.expect(result).be.a('array');
        chai_1.expect(result).be.length(1);
        chai_1.expect(result[0]).be.equal('expect(function() { calc(1, true); }).to.throw();');
    });
...
describe('generateSpec in chai style with semicolon false', function () {
    ...
    it('should generate spec for throw in es6 style and without semicolon', function () {
        var result = spec_generator_1.generateSpec('throw calc(1, true)', { special: true, semicolon: false });
        chai_1.expect(result).be.a('array');
        chai_1.expect(result).be.length(1);
        chai_1.expect(result[0]).be.equal('expect(() => calc(1, true)).to.throw()');
    });
    it('should generate spec for throw in es5 style and without semicolon', function () {
        var result = spec_generator_1.generateSpec('throw calc(1, true)', { special: true, es6: false, semicolon: false });
        chai_1.expect(result).be.a('array');
        chai_1.expect(result).be.length(1);
        chai_1.expect(result[0]).be.equal('expect(function() { calc(1, true) }).to.throw()');
    });
...
//# sourceMappingURL=spec-generator-chai.spec.js.map