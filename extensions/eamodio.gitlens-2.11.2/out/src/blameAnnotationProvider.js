            ...
            if (!isEmptyOrWhitespace) {
                switch (++count) {
                    case 0:
                        ...
                        break;
                    case 1:
                        gutter = `${blameAnnotationFormatter_1.cssIndent} ${blameAnnotationFormatter_1.BlameAnnotationFormatter.getAuthor(this._config, commit, blameAnnotationFormatter_1.defaultAuthorLength, true)}`;
                        break;
                    case 2:
                        gutter = `${blameAnnotationFormatter_1.cssIndent} ${blameAnnotationFormatter_1.BlameAnnotationFormatter.getDate(this._config, commit, this._config.annotation.dateFormat || 'MM/DD/YYYY', true, true)}`;
                        break;
                    default:
