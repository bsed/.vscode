...
const fastTagsSymbolProvider_1 = require('../src/symbolProviders/fastTagsSymbolProvider');
...
describe('FastTagsSymbolProvider', () => {
    ...
    describe('#getSymbolsForFile', () => {
        it('should return the correct symbols from a file', () => {
            let symbolProvider = new fastTagsSymbolProvider_1.FastTagsSymbolProvider(fastTagsCommand, cwd, logger);
    ...
    describe('#getSymbolsForFile', () => {
        ...
        it('should return an empty array when the directory is empty', () => {
            let symbolProvider = new fastTagsSymbolProvider_1.FastTagsSymbolProvider(fastTagsCommand, './test/fixtures/symbols/empty/', logger);
            return symbolProvider.getSymbolsForWorkspace({ query: 'b' }).then((symbols) => {
                assert.equal(symbols.length, 0);
            });
        });
...
//# sourceMappingURL=fastTagsSymbolProvider.spec.js.map